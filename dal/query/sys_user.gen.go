...
func newSysUser(db *gorm.DB, opts ...gen.DOOption) sysUser {
	...
	_sysUser.DelFlag = field.NewField(tableName, "del_flag")
	...
	_sysUser.DeleteTime = field.NewTime(tableName, "delete_time")
	_sysUser.Remark = field.NewString(tableName, "remark")
	_sysUser.SysRoleList = sysUserManyToManySysRoleList{
		db: db.Session(&gorm.Session{}),

		RelationField: field.NewRelation("SysRoleList", "model.SysRole"),
	}

	_sysUser.BelongToSysDept = sysUserBelongsToBelongToSysDept{
		db: db.Session(&gorm.Session{}),

		RelationField: field.NewRelation("BelongToSysDept", "model.SysDept"),
	}
...
type sysUser struct {
	...
	Remark      field.String
	SysRoleList sysUserManyToManySysRoleList

	BelongToSysDept sysUserBelongsToBelongToSysDept
...
func (s *sysUser) updateTableName(table string) *sysUser {
	...
	s.DelFlag = field.NewField(table, "del_flag")
...
func (s sysUser) clone(db *gorm.DB) sysUser {
	...
	s.SysRoleList.db = db.Session(&gorm.Session{Initialized: true})
	s.SysRoleList.db.Statement.ConnPool = db.Statement.ConnPool
	s.BelongToSysDept.db = db.Session(&gorm.Session{Initialized: true})
	s.BelongToSysDept.db.Statement.ConnPool = db.Statement.ConnPool
	return s
}

func (s sysUser) replaceDB(db *gorm.DB) sysUser {
	s.sysUserDo.ReplaceDB(db)
	s.SysRoleList.db = db.Session(&gorm.Session{})
	s.BelongToSysDept.db = db.Session(&gorm.Session{})
	return s
}

type sysUserManyToManySysRoleList struct {
	db *gorm.DB

	field.RelationField
}

func (a sysUserManyToManySysRoleList) Where(conds ...field.Expr) *sysUserManyToManySysRoleList {
	if len(conds) == 0 {
		return &a
	}
...
func (a sysUserManyToManySysRoleList) WithContext(ctx context.Context) *sysUserManyToManySysRoleList {
	a.db = a.db.WithContext(ctx)
	return &a
}

func (a sysUserManyToManySysRoleList) Session(session *gorm.Session) *sysUserManyToManySysRoleList {
	a.db = a.db.Session(session)
	return &a
}

func (a sysUserManyToManySysRoleList) Model(m *model.SysUser) *sysUserManyToManySysRoleListTx {
	return &sysUserManyToManySysRoleListTx{a.db.Model(m).Association(a.Name())}
}

func (a sysUserManyToManySysRoleList) Unscoped() *sysUserManyToManySysRoleList {
	a.db = a.db.Unscoped()
	return &a
}

type sysUserManyToManySysRoleListTx struct{ tx *gorm.Association }

func (a sysUserManyToManySysRoleListTx) Find() (result []*model.SysRole, err error) {
	return result, a.tx.Find(&result)
}

func (a sysUserManyToManySysRoleListTx) Append(values ...*model.SysRole) (err error) {
...
func (a sysUserManyToManySysRoleListTx) Replace(values ...*model.SysRole) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a sysUserManyToManySysRoleListTx) Delete(values ...*model.SysRole) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a sysUserManyToManySysRoleListTx) Clear() error {
	return a.tx.Clear()
}

func (a sysUserManyToManySysRoleListTx) Count() int64 {
	return a.tx.Count()
}

func (a sysUserManyToManySysRoleListTx) Unscoped() *sysUserManyToManySysRoleListTx {
	a.tx = a.tx.Unscoped()
	return &a
}

type sysUserBelongsToBelongToSysDept struct {
	db *gorm.DB

	field.RelationField
}

func (a sysUserBelongsToBelongToSysDept) Where(conds ...field.Expr) *sysUserBelongsToBelongToSysDept {
	if len(conds) == 0 {
		return &a
	}
...
func (a sysUserBelongsToBelongToSysDept) WithContext(ctx context.Context) *sysUserBelongsToBelongToSysDept {
	a.db = a.db.WithContext(ctx)
	return &a
}

func (a sysUserBelongsToBelongToSysDept) Session(session *gorm.Session) *sysUserBelongsToBelongToSysDept {
	a.db = a.db.Session(session)
	return &a
}

func (a sysUserBelongsToBelongToSysDept) Model(m *model.SysUser) *sysUserBelongsToBelongToSysDeptTx {
	return &sysUserBelongsToBelongToSysDeptTx{a.db.Model(m).Association(a.Name())}
}

func (a sysUserBelongsToBelongToSysDept) Unscoped() *sysUserBelongsToBelongToSysDept {
	a.db = a.db.Unscoped()
	return &a
}

type sysUserBelongsToBelongToSysDeptTx struct{ tx *gorm.Association }

func (a sysUserBelongsToBelongToSysDeptTx) Find() (result *model.SysDept, err error) {
	return result, a.tx.Find(&result)
}

func (a sysUserBelongsToBelongToSysDeptTx) Append(values ...*model.SysDept) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a sysUserBelongsToBelongToSysDeptTx) Replace(values ...*model.SysDept) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a sysUserBelongsToBelongToSysDeptTx) Delete(values ...*model.SysDept) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a sysUserBelongsToBelongToSysDeptTx) Clear() error {
	return a.tx.Clear()
}

func (a sysUserBelongsToBelongToSysDeptTx) Count() int64 {
	return a.tx.Count()
}

func (a sysUserBelongsToBelongToSysDeptTx) Unscoped() *sysUserBelongsToBelongToSysDeptTx {
	a.tx = a.tx.Unscoped()
	return &a
}
