...
func newSysDept(db *gorm.DB, opts ...gen.DOOption) sysDept {
	...
	_sysDept.DeleteTime = field.NewTime(tableName, "delete_time")
	_sysDept.DelFlag = field.NewField(tableName, "del_flag")
	_sysDept.Remark = field.NewString(tableName, "remark")
	_sysDept.SysUserList = sysDeptHasManySysUserList{
...
type sysDept struct {
	...
	DelFlag     field.Field
	Remark      field.String
	SysUserList sysDeptHasManySysUserList
...
type sysDeptHasManySysUserList struct {
	db *gorm.DB

	field.RelationField
}

func (a sysDeptHasManySysUserList) Where(conds ...field.Expr) *sysDeptHasManySysUserList {
	if len(conds) == 0 {
		return &a
	}
...
func (a sysDeptHasManySysUserList) WithContext(ctx context.Context) *sysDeptHasManySysUserList {
	a.db = a.db.WithContext(ctx)
	return &a
}

func (a sysDeptHasManySysUserList) Session(session *gorm.Session) *sysDeptHasManySysUserList {
	a.db = a.db.Session(session)
	return &a
}

func (a sysDeptHasManySysUserList) Model(m *model.SysDept) *sysDeptHasManySysUserListTx {
	return &sysDeptHasManySysUserListTx{a.db.Model(m).Association(a.Name())}
}

func (a sysDeptHasManySysUserList) Unscoped() *sysDeptHasManySysUserList {
	a.db = a.db.Unscoped()
	return &a
}

type sysDeptHasManySysUserListTx struct{ tx *gorm.Association }

func (a sysDeptHasManySysUserListTx) Find() (result []*model.SysUser, err error) {
	return result, a.tx.Find(&result)
}

func (a sysDeptHasManySysUserListTx) Append(values ...*model.SysUser) (err error) {
...
func (a sysDeptHasManySysUserListTx) Replace(values ...*model.SysUser) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a sysDeptHasManySysUserListTx) Delete(values ...*model.SysUser) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a sysDeptHasManySysUserListTx) Clear() error {
	return a.tx.Clear()
}

func (a sysDeptHasManySysUserListTx) Count() int64 {
	return a.tx.Count()
}

func (a sysDeptHasManySysUserListTx) Unscoped() *sysDeptHasManySysUserListTx {
	a.tx = a.tx.Unscoped()
	return &a
}
