...
func newSysRole(db *gorm.DB, opts ...gen.DOOption) sysRole {
	...
	_sysRole.DelFlag = field.NewField(tableName, "del_flag")
	...
	_sysRole.DeleteTime = field.NewTime(tableName, "delete_time")
	_sysRole.Remark = field.NewString(tableName, "remark")
	_sysRole.SysUserList = sysRoleManyToManySysUserList{
		db: db.Session(&gorm.Session{}),

		RelationField: field.NewRelation("SysUserList", "model.SysUser"),
	}
...
type sysRole struct {
	...
	Remark      field.String
	SysUserList sysRoleManyToManySysUserList
...
func (s sysRole) clone(db *gorm.DB) sysRole {
	...
	s.SysUserList.db = db.Session(&gorm.Session{Initialized: true})
	s.SysUserList.db.Statement.ConnPool = db.Statement.ConnPool
	return s
}

func (s sysRole) replaceDB(db *gorm.DB) sysRole {
	s.sysRoleDo.ReplaceDB(db)
	s.SysUserList.db = db.Session(&gorm.Session{})
	return s
}

type sysRoleManyToManySysUserList struct {
	db *gorm.DB

	field.RelationField
}

func (a sysRoleManyToManySysUserList) Where(conds ...field.Expr) *sysRoleManyToManySysUserList {
	if len(conds) == 0 {
		return &a
	}
...
func (a sysRoleManyToManySysUserList) WithContext(ctx context.Context) *sysRoleManyToManySysUserList {
	a.db = a.db.WithContext(ctx)
	return &a
}

func (a sysRoleManyToManySysUserList) Session(session *gorm.Session) *sysRoleManyToManySysUserList {
	a.db = a.db.Session(session)
	return &a
}

func (a sysRoleManyToManySysUserList) Model(m *model.SysRole) *sysRoleManyToManySysUserListTx {
	return &sysRoleManyToManySysUserListTx{a.db.Model(m).Association(a.Name())}
}

func (a sysRoleManyToManySysUserList) Unscoped() *sysRoleManyToManySysUserList {
	a.db = a.db.Unscoped()
	return &a
}

type sysRoleManyToManySysUserListTx struct{ tx *gorm.Association }

func (a sysRoleManyToManySysUserListTx) Find() (result []*model.SysUser, err error) {
	return result, a.tx.Find(&result)
}

func (a sysRoleManyToManySysUserListTx) Append(values ...*model.SysUser) (err error) {
...
func (a sysRoleManyToManySysUserListTx) Replace(values ...*model.SysUser) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a sysRoleManyToManySysUserListTx) Delete(values ...*model.SysUser) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a sysRoleManyToManySysUserListTx) Clear() error {
	return a.tx.Clear()
}

func (a sysRoleManyToManySysUserListTx) Count() int64 {
	return a.tx.Count()
}

func (a sysRoleManyToManySysUserListTx) Unscoped() *sysRoleManyToManySysUserListTx {
	a.tx = a.tx.Unscoped()
	return &a
}
