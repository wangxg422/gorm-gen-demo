...
var AutoCreateTimeTag = gen.FieldGORMTag("create_time", func(tag field.GormTag) field.GormTag {
	tag.Append("autoCreateTime", "true")
	return tag
})

var AutoUpdateTimeTag = gen.FieldGORMTag("update_time", func(tag field.GormTag) field.GormTag {
	tag.Append("autoUpdateTime", "true")
	return tag
})

var AutoDeleteTimeTag = gen.FieldGORMTag("delete_time", func(tag field.GormTag) field.GormTag {
